...
ConvertFrom-StringData @'
    ...
    ResourceExistsButShouldNotMessage        = '{0}' exists but should not. (NCA0007)
    ResourceDoesNotExistButShouldMessage     = '{0}' does not exist but should. (NCA0008)
    ResourceDoesNotExistAndShouldNotMessage  = '{0}' does not exist and should not. (NCA0009)
'@
