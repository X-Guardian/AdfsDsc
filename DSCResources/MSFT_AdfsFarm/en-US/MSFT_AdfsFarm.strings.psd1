...
ConvertFrom-StringData @'
    TestingResourceMessage                      = Testing '{0}'. (FRM001)
    SettingResourceMessage                      = Setting '{0}'. (FRM002)
    InstallingResourceMessage                   = Installing '{0}'. (FRM003)
    ResourceInstallSuccessMessage               = '{0}' has been installed successfully. A reboot is now required. (FRM004)
    ResourceInDesiredStateMessage               = '{0}' is in the desired state. (FRM005)
    ResourceIsAbsentButShouldBePresentMessage   = '{0}' is absent but should be present. (FRM006)
    MissingAdfsAssembliesMessage                = Required ADFS assemblies can't be found. Reboot required. (FRM007)
